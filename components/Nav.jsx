  ...
  return (
    <div className="w-full h-[76px] px-[96px] bg-white shadow justify-center items-center inline-flex">
      <div className="w-full h-[76px] flex-row justify-between items-center flex">
        <div className="pr-[58.03px] pb-1 justify-start items-center  gap-3 inline-flex">
          <img
        ...
        <div>
          ...
          <div className="w-[150px] h-9 pl-[25.78px] pr-[25.43px] py-1.5 bg-[#264653] rounded-md justify-center items-center inline-flex">
            <div className="w-[98.79px] h-6 text-center text-white text-sm font-bold font-['Quicksand'] leading-normal tracking-wide">
              Start for free
            </div>
          </div>
        </div>
